...
abstract contract BoundERC1155 is ERC1155, ERC20 {
    ...
    uint256 constant private ERC20_ID = 0;
    ...
    uint256 immutable private _erc20PerNft;
    ...
    mapping (address tokenOwner => uint256[]) private _ownedTokens;
